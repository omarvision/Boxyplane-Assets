...
public class Cow : MonoBehaviour
{
    ...
    {        
        ...
        if (targetobj == null)
        {
            ...
            targetobj.name = this.name + "_cube";
            targetobj.GetComponent<Renderer>().material.color = Color.black;
        ...
        Debug.Log(this.name + " - " + transform.position.x.ToString("000") + ", " + transform.position.z.ToString("000"));
    }
	...
	private void Update ()
    {
        ...
        Debug.DrawLine(transform.position, new Vector3(transform.position.x, transform.position.y + 25.0f, transform.position.z), Color.magenta);
	}
